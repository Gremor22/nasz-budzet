-- Tożsamość w gospodarstwie (Paweł/Milena), zaproszenia tylko dla ownera,
-- dołączanie z saldem, wyrzucanie członków.

-- Drop old single-arg overload if present, then recreate with person_key.
